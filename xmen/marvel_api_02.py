...
def main():           
    ...
    print(uncannyxmen)
    # Userinput_return()
    userinput=input("Image, COmic List, ComicSummary, series, stories: ").lower()
    if userinput in uncannyxmen.keys():
        print(f"{uncannyxmen[userinput]}")
...
if __name__ == '__main__':
   ...
   # parser.add_argument('id', help ='provide seven digit unique character id')
